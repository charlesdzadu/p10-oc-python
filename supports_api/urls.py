...
from .views import CommentViewSet, IssueViewSet, ProjectViewSet, UserViewSet
    ...
    @extend_schema(
        ...
        examples=[
            OpenApiExample(
                ...
                value={"username": "votre_username", "password": "votre_password"},
            )
        ],
        responses={
            200: {
...
class DocumentedTokenRefreshView(TokenRefreshView):
    @extend_schema(
        ...
        examples=[
            OpenApiExample(
                "Exemple rafraîchissement", value={"refresh": "votre_refresh_token"}
            )
        ],
        responses={
            200: {
