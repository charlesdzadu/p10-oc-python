    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('age', models.PositiveIntegerField(validators=[django.core.validators.MinValueValidator(15, "L'utilisateur doit avoir au moins 15 ans selon le RGPD")])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('priority', models.CharField(choices=[('LOW', 'Faible'), ('MEDIUM', 'Moyenne'), ('HIGH', 'Élevée')], default='MEDIUM', max_length=6)),
                ('status', models.CharField(choices=[('To Do', 'À faire'), ('In Progress', 'En cours'), ('Finished', 'Terminé')], default='To Do', max_length=11)),
                ('tag', models.CharField(choices=[('BUG', 'Bug'), ('FEATURE', 'Fonctionnalité'), ('TASK', 'Tâche')], max_length=7)),
                ('created_time', models.DateTimeField(auto_now_add=True)),
                ('updated_time', models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('issue', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='supports_api.issue')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='issue',
            name='project',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='issues', to='supports_api.project'),
        ),
        migrations.CreateModel(
            name='Contributor',
            fields=[
                ...
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='contributors', to='supports_api.project')),
            ],
            options={
