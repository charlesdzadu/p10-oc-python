...
class CustomUserAdmin(UserAdmin):
    ...
    list_display = ('username', 'email', 'age', 'can_be_contacted', 'can_data_be_shared', 'is_active')
...
class IssueAdmin(admin.ModelAdmin):
    ...
    list_display = ('title', 'project', 'author', 'assigned_to', 'priority', 'status', 'tag', 'created_time')
